...
namespace WebAPI.Controllers
{
    ...
    public class DepartmentController : ControllerBase
    {
        ...
        {
            string querry = @"select DepartmentId,DepartmentName from Department";
        ...
        {
            string querry = @"insert into Department values 
                                ('" + dep.DepartmentName + @"')
                               ";
            DataTable table = new DataTable();
            string sqlDataSource = _configuration.GetConnectionString("EmployeeAppConn");
        ...
        {
            string querry = @"update Department set 
        ...
        {
            string querry = @"delete from Department 
